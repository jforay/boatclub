...
from .views import AllReservationsView, DailyReservationsView, ReserveBoatView, reservation_detail_view
from .views import cancel_reservation, DailyScheduleView, reservation_calendar_view, marinas_for_schedule_view, marina_schedule_view, schedule_or_reservations_view
